...
class YelpProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(self._read_csv(os.path.join(data_dir,"train.csv")), set_type="train")

    def get_dev_examples(self, data_file):
        """Gets a collection of `InputExample`s for the dev set."""
        return self._create_examples(self._read_csv(os.path.join(data_dir,"dev.csv")), set_type="dev")
